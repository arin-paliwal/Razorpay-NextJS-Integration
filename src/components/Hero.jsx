    ...
    <>
      <div className="flex flex-wrap p-8">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8 mt-[-4rem] space-y-5">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-5xl xl:leading-tight dark:text-white">
              Pay to Arin Paliwal for All Technical Services via Razorpay
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
              Welcome to payment page! My name is Arin Paliwal, and I am a
              passionate web developer, UI/UX developer, coder, and data
              structures and algorithms enthusiast. I am also a current
              engineering student pursuing a degree in Machine Learning &
              Artificial Intelligence from Pranveer Singh Institute of
              Technology.You can pay me here for all technical services you have subscribed to.
            </p>
            <div className="flex gap-4 flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <div
      ...
      <div>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Providing Services to<span className="text-indigo-600">500+</span>{" "}
            customers worldwide
          </div>
